...
<head>
	<meta charset="UTF-8">
	<title>Peterscan - Conociendo al Weimaraner</title>
...
<body>
	...
	<section class="Main">
		...
		<section class="Contenedor-contenido">
			<aside>
				<img src="img/banners/weimaraner.jpg" alt="Conociendo al Weimaraner">
			</aside> <!-- End of aside -->
			...
			<div class="Contenido">
				<article>
					...
					<p>
						...
						dulce y pelaje aterciopelado es tambi&eacute;n, un perro exigente, 
						posesivo, dependiente de la presencia de uno o m&aacute;s 
						integrantes de la familia Es muy demostrativo al manifestar su 
						disconformidad en situaciones que le desagradan, por ejemplo, 
						mordiendo las manos, saltando sobre el cuerpo, arruinando objetos 
						personales o de la casa, destruyendo muebles o plantas, abriendo 
						canillas para dejar correr el agua, abriendo puertas etc. Es bueno 
					...
					<h2>LA EDUCACION</h2>
					<p>
						Es preciso informarse sobre las caracter&iacute;sticas y 
						or&iacute;genes de la raza, esta informaci&oacute;n, 
						permitir&aacute; saber si se adaptar&aacute; a nuestro estilo de 
						vida, si podremos cubrir sus necesidades y como es su 
						educaci&oacute;n. De la ense&ntilde;anza que le brindemos y del 
					...
					<p>
						...
						A quedarse solo las veces que sea necesario en diferentes momentos 
					...
					<p>
						...
						gestos, las miradas, la postura corporal, los tonos de voz, 
						tienen m&aacute;s peso que las palabras. Por ejemplo, si le 
						ordenamos al perro que deje un objeto que tiene en la boca, o que 
						no suba a la mesada de la cocina con una sonrisa o tono de 
						voz suave, es casi seguro que no obedecer&aacute; la orden, 
						debido a que la sonrisa est&aacute; asociada por el perro a 
						momentos de juego o aprobaci&oacute;n y el tono de voz suave lo 
					...
					<p>
						...
						siendo ruidosos, destructivos, o ambas cosas. He needs free 
						running exercise as well as disciplined walking and also to have 
						his mind occupied. Necesita correr al aire libre, hacer ejercicio, 
				...
				<p>
					No es una raza para todos y dif&iacute;cil de hacer una mascota de 
					&eacute;l, pero quienes acepten el desafi&oacute; de compartir la 
					vida con un Weimaraner, descubrir&aacute;n un perro de una gran 
					sensibilidad y de una inteligencia notable. 
					Es muy f&aacute;cil darse cuenta de lo que necesita, de lo que le 
					gusta o le disgusta. 
					&Eacute;l, puede ser un excelente compa&ntilde;ero y un buen perro 
					de familia.
				</p>
				...
				<p>
					...
					particularidades. Es necesario conocer la naturaleza de la raza, 
				...
				<p>
					...
					propietarios al curso de adiestramiento de su perro. La 
					participaci&oacute;n en las pr&aacute;cticas de los ejercicios de 
					obediencia aprendidos por el perro, les permitir&aacute; tener 
					autoridad sobre &eacute;l y ser cre&iacute;bles a la hora de pedirle 
					que obedezca una orden. De lo contrario, si estas pr&aacute;cticas no 
