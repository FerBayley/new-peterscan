...
<head>
	<meta charset="UTF-8">
	<title>Cachorros - Planificación y desarrollo del adiestramiento - PetersCan - Adietramiento Canino</title>
...
<body>
	...
	<section class="Main">
		...
		<section class="Descripcion-seccion">
			<p>SECCION: Planificaci&oacute;n y desarrollo del adiestramiento</p>
		...
		<section class="Contenedor-contenido">
			<aside>
				<ul>
					...
					<li><a href="">COMO EDUCAR A UN CACHORRO SEGUN SUS CARACTERISTICAS Y NECESIDADES</a></li>
					<li><a href="">QUE ENSEÑARLES DESDE EL PRIMER DIA EN NUESTRO HOGAR</a></li>
					<li>PLANIFICACION DEL ADIESTRAMEINTO</li>
			...
			<div class="Contenido">
				<article>
					<h2>PLANIFICACION Y DESARROLLO DEL ADIESTRAMEINTO</h2>

					<p>
						En una primera entrevista planifico el adiestramiento, teniendo en cuenta 
						las caracter&aicute;sticas particulares del cachorro, la raza, si hay 
						beb&eacute;s o ni&ntilde;os en la familia, y las necesidades de sus 
						propietarios.
					</p>					
					...
					<p>
						En este primer encuentro y durante el transcurso de toda la ense&ntilde;anza al 
						cachorro, brindo adem&aacute;s amplia informaci&oacute;n sobre sus necesidades y 
						educaci&oacute;n, que acompa&ntilde;a y complementa al adiestramiento. .
					</p>	
					...
					<p>
						La planificaci&oacute;n consiste en establecer el tiempo del adiestramiento, 
						la duraci&oacute;n y la cantidad de clases por semana, los lugares donde 
						el cachorro aprender&aacute; los ejercicios de obediencia y c&oacute;mo 
						ser&aacute; la participaci&oacute;n de los due&ntilde;os en la 
						pr&aacute;ctica del adiestramiento.
					</p>	
					...
					<p>
						Trabajo en forma personalizada, detectando las necesidades de cada uno de 
						los integrantes de la familia y su conexi&oacute;n con el cachorro, 
					...
					<p>
						Mi tarea consiste en asesorar, ense&ntilde;ar y transmitir que tener un 
						cachorro es tener un amigo, significa un compromiso, el de cuidar a otro 
						ser que sin nosotros estar&iacute;a indefenso.
					</p>
